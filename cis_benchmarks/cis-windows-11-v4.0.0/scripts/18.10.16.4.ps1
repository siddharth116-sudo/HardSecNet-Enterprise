...
$Name = "DoNotShowFeedbackNoti"
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "DoNotShowFeedbackNoti = 1"
$SettingTitle = "18.10.16.4 - Ensure 'Do not show feedback notifications' is set to 'Enabled'"
