...
$PropertyType = "DWord"
$DesiredValue = 0
$ExpectedDescription = "RDVRecoveryPassword = 0"
$SettingTitle = "18.10.10.3.4 - (BL) Ensure 'Choose how BitLocker-protected removable drives can be recovered: Recovery Password' is set to 'Enabled: Do not allow 48-digit recovery password'"
