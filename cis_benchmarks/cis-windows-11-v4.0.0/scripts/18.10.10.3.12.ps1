...
$PropertyType = "DWord"
$DesiredValue = 0
$ExpectedDescription = "RDVDenyCrossOrg = 0"
$SettingTitle = "18.10.10.3.12 - (BL) Ensure 'Deny write access to removable drives not protected by BitLocker: Do not allow write access to devices configured in another organization' is set to 'Enabled: False'"
