...
$PropertyType = "DWord"
$DesiredValue = 5
$ExpectedDescription = "LmCompatibilityLevel = 5"
$SettingTitle = "2.3.11.7 - Ensure 'Network security: LAN Manager authentication level' is set to 'Send NTLMv2 response only. Refuse LM & NTLM'"
