...
$PropertyType = "DWord"
$DesiredValue = 5
$ExpectedDescription = "RpcProtocols = 5"
$SettingTitle = "18.7.5 - Ensure 'Configure RPC listener settings: Protocols to allow for incoming RPC connections' is set to 'Enabled: RPC over TCP'"
