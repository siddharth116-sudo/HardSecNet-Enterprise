...
$Name = "TcpMaxDataRetransmiss"
$PropertyType = "DWord"
$DesiredValue = 3
$ExpectedDescription = "TcpMaxDataRetransmiss = 3"
$SettingTitle = "18.5.12 - Ensure 'MSS: (TcpMaxDataRetransmissions) How many times unacknowledged data is retransmitted' is set to 'Enabled: 3'"
