...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "LimitBlankPasswordUse = 1"
$SettingTitle = "2.3.1.2 - Ensure 'Accounts: Limit local account use of blank passwords to console logon only' is set to 'Enabled'"
