...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "FDVManageDRA = 1"
$SettingTitle = "18.10.10.1.3 - (BL) Ensure 'Choose how BitLocker-protected fixed drives can be recovered: Allow data recovery agent' is set to 'Enabled: True'"
