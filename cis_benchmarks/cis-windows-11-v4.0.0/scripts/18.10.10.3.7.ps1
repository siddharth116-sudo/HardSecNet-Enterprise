...
$PropertyType = "DWord"
$DesiredValue = 0
$ExpectedDescription = "RDVHardwareEncryption = 0"
$SettingTitle = "18.10.10.3.7 - (BL) Ensure 'Configure use of hardware-based encryption for removable data drives' is set to 'Disabled'"
