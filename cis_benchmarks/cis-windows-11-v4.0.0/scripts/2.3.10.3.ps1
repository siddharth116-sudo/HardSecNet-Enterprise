...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "RestrictAnonymous = 1"
$SettingTitle = "2.3.10.3 - Ensure 'Network access: Do not allow anonymous enumeration of SAM accounts and shares' is set to 'Enabled'"
