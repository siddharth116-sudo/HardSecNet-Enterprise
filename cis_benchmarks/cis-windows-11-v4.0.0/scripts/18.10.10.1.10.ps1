...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "FDVEnforceUserCert = 1"
$SettingTitle = "18.10.10.1.10 - (BL) Ensure 'Configure use of smart cards on fixed data drives: Require use of smart cards on fixed data drives' is set to 'Enabled: True'"
