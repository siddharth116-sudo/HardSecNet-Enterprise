...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "EnableInstallerDetection = 1"
$SettingTitle = "2.3.17.4 - Ensure 'User Account Control: Detect application installations and prompt for elevation' is set to 'Enabled'"
