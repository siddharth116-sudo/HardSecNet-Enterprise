...
$PropertyType = "DWord"
$DesiredValue = 90
$ExpectedDescription = "WarningLevel = 90"
$SettingTitle = "18.5.13 - Ensure 'MSS: (WarningLevel) Percentage threshold for the security event log at which the system will generate a warning' is set to 'Enabled: 90% or less'"
