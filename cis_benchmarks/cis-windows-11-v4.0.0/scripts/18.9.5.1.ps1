...
$Name = "EnableVirtualizationBase"
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "EnableVirtualizationBase = 1"
$SettingTitle = "18.9.5.1 - Ensure 'Turn On Virtualization Based Security' is set to 'Enabled'"
