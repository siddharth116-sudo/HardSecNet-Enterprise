...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "enableforcedlogoff = 1"
$SettingTitle = "2.3.9.4 - Ensure 'Microsoft network server: Disconnect clients when logon hours expire' is set to 'Enabled'"
