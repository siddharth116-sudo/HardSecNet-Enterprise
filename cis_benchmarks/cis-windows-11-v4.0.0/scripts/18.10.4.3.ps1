...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "BlockNonAdminUserInstall = 1"
$SettingTitle = "18.10.4.3 - Ensure 'Prevent non-admin users from installing packaged Windows apps' is set to 'Enabled'"
