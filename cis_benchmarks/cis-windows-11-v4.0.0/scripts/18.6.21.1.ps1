...
$Name = "fMinimizeConnecti"
$PropertyType = "DWord"
$DesiredValue = 3
$ExpectedDescription = "fMinimizeConnecti = 3"
$SettingTitle = "18.6.21.1 - Ensure 'Minimize the number of simultaneous connections to the Internet or a Windows Domain' is set to 'Enabled: 3 = Prevent Wi-Fi when on Ethernet'"
