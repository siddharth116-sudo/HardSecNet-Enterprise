...
$PropertyType = "DWord"
$DesiredValue = 3
$ExpectedDescription = "DriverLoadPolicy = 3"
$SettingTitle = "18.9.13.1 - Ensure 'Boot-Start Driver Initialization Policy' is set to 'Enabled: Good, unknown and bad but critical'"
