...
$PropertyType = "DWord"
$DesiredValue = 0
$ExpectedDescription = "D = 0"
$SettingTitle = "18.9.47.5.1 - Ensure 'Microsoft Support Diagnostic Tool: Turn on MSDT interactive communication with support provider' is set to 'Disabled'"
