...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "NoLMHash = 1"
$SettingTitle = "2.3.11.5 - Ensure 'Network security: Do not store LAN Manager hash value on next password change' is set to 'Enabled'"
