...
$Name = "HideRecommendedPersonalized"
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "HideRecommendedPersonalized = 1"
$SettingTitle = "18.8.2 - Ensure 'Remove Personalized Website Recommendations from the Recommended section in the Start Menu' is set to 'Enabled'"
