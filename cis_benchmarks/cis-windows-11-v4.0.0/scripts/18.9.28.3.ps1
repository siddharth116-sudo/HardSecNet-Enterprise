...
$Name = "DisableLockScreenAppNotificat"
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "DisableLockScreenAppNotificat = 1"
$SettingTitle = "18.9.28.3 - Ensure 'Turn off app notifications on the lock screen' is set to 'Enabled'"
