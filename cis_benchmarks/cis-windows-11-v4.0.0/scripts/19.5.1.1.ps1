...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "NoToastApplicationNotificationOnLockScreen = 1"
$SettingTitle = "19.5.1.1 - Ensure 'Turn off toast notifications on the lock screen' is set to 'Enabled'"
