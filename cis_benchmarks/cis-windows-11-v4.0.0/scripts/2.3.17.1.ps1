...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "FilterAdministratorToken = 1"
$SettingTitle = "2.3.17.1 - Ensure 'User Account Control: Admin Approval Mode for the Built-in Administrator account' is set to 'Enabled'"
