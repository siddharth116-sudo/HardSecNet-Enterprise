...
$PropertyType = "DWord"
$DesiredValue = 2
$ExpectedDescription = "SecurityLayer = 2"
$SettingTitle = "18.10.57.3.9.3 - Ensure 'Require use of specific security layer for remote (RDP) connections' is set to 'Enabled: SSL'"
