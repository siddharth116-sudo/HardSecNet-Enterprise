...
$PropertyType = "DWord"
$DesiredValue = 0
$ExpectedDescription = "SafeForScripting = 0"
$SettingTitle = "18.10.81.3 - Ensure 'Prevent Internet Explorer security prompt for Windows Installer scripts' is set to 'Disabled'"
