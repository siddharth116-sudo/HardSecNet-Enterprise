...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "NoLocalPasswordResetQuestions = 1"
$SettingTitle = "18.10.15.3 - Ensure 'Prevent the use of security questions for local accounts' is set to 'Enabled'"
