...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "HVCIMATRequired = 1"
$SettingTitle = "18.9.5.4 - Ensure 'Turn On Virtualization Based Security: Require UEFI Memory Attributes Table' is set to 'True (checked)'"
