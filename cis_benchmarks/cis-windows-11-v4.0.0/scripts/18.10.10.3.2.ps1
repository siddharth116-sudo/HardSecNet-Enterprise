...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "RDVRecovery = 1"
$SettingTitle = "18.10.10.3.2 - (BL) Ensure 'Choose how BitLocker-protected removable drives can be recovered' is set to 'Enabled'"
