...
$Name = "NoLockScreenSlidesho"
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "NoLockScreenSlidesho = 1"
$SettingTitle = "18.1.1.2 - Ensure 'Prevent enabling lock screen slide show' is set to 'Enabled'"
