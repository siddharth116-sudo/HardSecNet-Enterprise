...
$PropertyType = "DWord"
$DesiredValue = 0
$ExpectedDescription = "EnableICMPRedirect = 0"
$SettingTitle = "18.5.5 - Ensure 'MSS: (EnableICMPRedirect) Allow ICMP redirects to override OSPF generated routes' is set to 'Disabled'"
