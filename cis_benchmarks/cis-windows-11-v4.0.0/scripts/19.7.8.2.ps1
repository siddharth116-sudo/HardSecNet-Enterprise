...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "DisableThirdPartySuggestions = 1"
$SettingTitle = "19.7.8.2 - Ensure 'Do not suggest third-party content in Windows spotlight' is set to 'Enabled'"
