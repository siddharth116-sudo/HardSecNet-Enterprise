...
$Name = "EnableExperimentalFeatu"
$PropertyType = "DWord"
$DesiredValue = 0
$ExpectedDescription = "EnableExperimentalFeatu = 0"
$SettingTitle = "18.10.18.2 - Ensure 'Enable App Installer Experimental Features' is set to 'Disabled'"
