...
$Name = "AuditServerDoesNot"
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "AuditServerDoesNot = 1"
$SettingTitle = "18.6.8.2 - Ensure 'Audit server does not support encryption' is set to 'Enabled'"
