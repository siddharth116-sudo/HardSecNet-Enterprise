...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "FDVHideRecoveryPage = 1"
$SettingTitle = "18.10.10.1.6 - (BL) Ensure 'Choose how BitLocker-protected fixed drives can be recovered: Omit recovery options from the BitLocker setup wizard' is set to 'Enabled: True'"
