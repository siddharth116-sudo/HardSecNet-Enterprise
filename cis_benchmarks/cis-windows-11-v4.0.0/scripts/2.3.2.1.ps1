...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "SCENoApplyLegacyAuditPolicy = 1"
$SettingTitle = "2.3.2.1 - Ensure 'Audit: Force audit policy subcategory settings (Windows Vista or later) to override audit policy category settings' is set to 'Enabled'"
