...
$Name = "ConfigureSystemGuardLaun"
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "ConfigureSystemGuardLaun = 1"
$SettingTitle = "18.9.5.6 - Ensure 'Turn On Virtualization Based Security: Secure Launch Configuration' is set to 'Enabled'"
