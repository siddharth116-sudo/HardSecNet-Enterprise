...
$Name = "NoHeapTerminationOnCorrupti"
$PropertyType = "DWord"
$DesiredValue = 0
$ExpectedDescription = "NoHeapTerminationOnCorrupti = 0"
$SettingTitle = "18.10.29.5 - Ensure 'Turn off heap termination on corruption' is set to 'Disabled'"
