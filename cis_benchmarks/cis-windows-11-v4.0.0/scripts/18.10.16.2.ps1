...
$Name = "DisableEnterpriseAuth"
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "DisableEnterpriseAuth = 1"
$SettingTitle = "18.10.16.2 - Ensure 'Configure Authenticated Proxy usage for the Connected User Experience and Telemetry service' is set to 'Enabled: Disable Authenticated Proxy usage'"
