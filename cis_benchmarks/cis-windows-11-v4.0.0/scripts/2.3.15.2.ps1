...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "ProtectionMode = 1"
$SettingTitle = "2.3.15.2 - Ensure 'System objects: Strengthen default permissions of internal system objects (e.g. Symbolic Links)' is set to 'Enabled'"
