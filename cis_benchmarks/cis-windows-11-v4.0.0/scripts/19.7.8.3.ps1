...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "DisableTailoredExperiencesWithDiagnosticData = 1"
$SettingTitle = "19.7.8.3 - Ensure 'Do not use diagnostic data for tailored experiences' is set to 'Enabled'"
