...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "RDVManageDRA = 1"
$SettingTitle = "18.10.10.3.3 - (BL) Ensure 'Choose how BitLocker-protected removable drives can be recovered: Allow data recovery agent' is set to 'Enabled: True'"
