...
$PropertyType = "DWord"
$DesiredValue = 0
$ExpectedDescription = "EnablePlainTextPassword = 0"
$SettingTitle = "2.3.8.3 - Ensure 'Microsoft network client: Send unencrypted password to third-party SMB servers' is set to 'Disabled'"
