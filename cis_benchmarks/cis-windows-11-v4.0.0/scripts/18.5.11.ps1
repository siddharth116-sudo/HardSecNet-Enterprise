...
$Name = "TcpMaxDataRetransmis"
$PropertyType = "DWord"
$DesiredValue = 3
$ExpectedDescription = "TcpMaxDataRetransmis = 3"
$SettingTitle = "18.5.11 - Ensure 'MSS: (TcpMaxDataRetransmissions IPv6) How many times unacknowledged data is retransmitted' is set to 'Enabled: 3'"
