...
$PropertyType = "DWord"
$DesiredValue = 0
$ExpectedDescription = "RpcAuthentication = 0"
$SettingTitle = "18.7.4 - Ensure 'Configure RPC connection settings: Use authentication for outgoing RPC connections' is set to 'Enabled: Default'"
