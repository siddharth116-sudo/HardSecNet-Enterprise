...
$PropertyType = "DWord"
$DesiredValue = 0
$ExpectedDescription = "ConsentPromptBehaviorUser = 0"
$SettingTitle = "2.3.17.3 - Ensure 'User Account Control: Behavior of the elevation prompt for standard users' is set to 'Automatically deny elevation requests'"
