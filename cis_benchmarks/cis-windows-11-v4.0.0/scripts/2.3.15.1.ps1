...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "ObCaseInsensitive = 1"
$SettingTitle = "2.3.15.1 - Ensure 'System objects: Require case insensitivity for non-Windows subsystems' is set to 'Enabled'"
