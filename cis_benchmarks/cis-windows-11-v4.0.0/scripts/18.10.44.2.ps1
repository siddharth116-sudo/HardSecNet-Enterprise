...
$PropertyType = "DWord"
$DesiredValue = 0
$ExpectedDescription = "AllowCameraMicrophoneRedirection = 0"
$SettingTitle = "18.10.44.2 - Ensure 'Allow camera and microphone access in Microsoft Defender Application Guard' is set to 'Disabled'"
