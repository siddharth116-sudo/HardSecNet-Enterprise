...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "DisableGraphRecentItems = 1"
$SettingTitle = "18.10.29.2 - Ensure 'Turn off account-based insights, recent, favorite, and recommended files in File Explorer' is set to 'Enabled'"
