...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "DenyDevic = 1"
$SettingTitle = "18.9.7.1.3 - (BL) Ensure 'Prevent installation of devices using drivers that match these device setup classes: Also apply to matching devices that are already installed.' is set to 'True' (checked)"
