...
$Name = "DisableMotWOnInsecurePathCo"
$PropertyType = "DWord"
$DesiredValue = 0
$ExpectedDescription = "DisableMotWOnInsecurePathCo = 0"
$SettingTitle = "18.10.29.4 - Ensure 'Do not apply the Mark of the Web tag to files copied from insecure sources' is set to 'Disabled'"
