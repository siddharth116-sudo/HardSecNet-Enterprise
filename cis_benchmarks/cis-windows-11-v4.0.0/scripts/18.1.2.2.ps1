...
$Name = "AllowInputPersonalizati"
$PropertyType = "DWord"
$DesiredValue = 0
$ExpectedDescription = "AllowInputPersonalizati = 0"
$SettingTitle = "18.1.2.2 - Ensure 'Allow users to enable online speech recognition services' is set to 'Disabled'"
