...
$Name = "BlockUserFromShowingAccountDe"
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "BlockUserFromShowingAccountDe = 1"
$SettingTitle = "18.9.28.1 - Ensure 'Block user from showing account details on sign-in' is set to 'Enabled'"
