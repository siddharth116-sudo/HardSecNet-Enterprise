...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "UseMachineId = 1"
$SettingTitle = "2.3.11.1 - Ensure 'Network security: Allow Local System to use computer identity for NTLM' is set to 'Enabled'"
