...
$Name = "DisableIPSourceRoutin"
$PropertyType = "DWord"
$DesiredValue = 2
$ExpectedDescription = "DisableIPSourceRoutin = 2"
$SettingTitle = "18.5.3 - Ensure 'MSS: (DisableIPSourceRouting) IP source routing protection level' is set to 'Enabled: Highest protection, source routing is completely disabled'"
