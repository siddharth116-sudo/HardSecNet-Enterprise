...
$Name = "PreventHandwritingDataShari"
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "PreventHandwritingDataShari = 1"
$SettingTitle = "18.9.20.1.3 - Ensure 'Turn off handwriting personalization data sharing' is set to 'Enabled'"
