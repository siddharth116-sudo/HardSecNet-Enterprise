...
$PropertyType = "DWord"
$DesiredValue = 0
$ExpectedDescription = "AllowPersistence = 0"
$SettingTitle = "18.10.44.3 - Ensure 'Allow data persistence for Microsoft Defender Application Guard' is set to 'Disabled'"
