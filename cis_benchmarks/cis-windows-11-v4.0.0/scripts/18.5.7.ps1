...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "NoNameReleaseOnDemand = 1"
$SettingTitle = "18.5.7 - Ensure 'MSS: (NoNameReleaseOnDemand) Allow the computer to ignore NetBIOS name release requests except from WINS servers' is set to 'Enabled'"
