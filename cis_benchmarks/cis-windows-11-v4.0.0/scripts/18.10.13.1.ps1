...
$Name = "DisableConsumerAccountS"
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "DisableConsumerAccountS = 1"
$SettingTitle = "18.10.13.1 - Ensure 'Turn off cloud consumer account state content' is set to 'Enabled'"
