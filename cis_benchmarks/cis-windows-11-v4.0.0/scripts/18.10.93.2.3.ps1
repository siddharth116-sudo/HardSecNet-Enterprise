...
$Name = "AllowTemporaryEnterpri"
$PropertyType = "DWord"
$DesiredValue = 0
$ExpectedDescription = "AllowTemporaryEnterpri = 0"
$SettingTitle = "18.10.93.2.3 - Ensure 'Enable features introduced via servicing that are off by default' is set to 'Disabled'"
