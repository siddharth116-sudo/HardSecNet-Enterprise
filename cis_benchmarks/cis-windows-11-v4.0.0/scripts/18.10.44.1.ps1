...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "AuditApplicationGuard = 1"
$SettingTitle = "18.10.44.1 - Ensure 'Allow auditing events in Microsoft Defender Application Guard' is set to 'Enabled'"
