...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "DisableExternalDMAUnderLock = 1"
$SettingTitle = "18.10.10.4 - (BL) Ensure 'Disable new DMA devices when this computer is locked' is set to 'Enabled'"
