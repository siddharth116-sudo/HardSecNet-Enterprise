...
$PropertyType = "DWord"
$DesiredValue = 0
$ExpectedDescription = "AllowOnlineID = 0"
$SettingTitle = "2.3.11.3 - Ensure 'Network Security: Allow PKU2U authentication requests to this computer to use online identities' is set to 'Disabled'"
