...
$Name = "DisableIPSourceRouti"
$PropertyType = "DWord"
$DesiredValue = 2
$ExpectedDescription = "DisableIPSourceRouti = 2"
$SettingTitle = "18.5.2 - Ensure 'MSS: (DisableIPSourceRouting IPv6) IP source routing protection level' is set to 'Enabled: Highest protection, source routing is completely disabled'"
