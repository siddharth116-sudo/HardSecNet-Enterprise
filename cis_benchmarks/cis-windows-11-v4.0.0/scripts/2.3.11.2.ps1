...
$PropertyType = "DWord"
$DesiredValue = 0
$ExpectedDescription = "AllowNullSessionFallback = 0"
$SettingTitle = "2.3.11.2 - Ensure 'Network security: Allow LocalSystem NULL session fallback' is set to 'Disabled'"
