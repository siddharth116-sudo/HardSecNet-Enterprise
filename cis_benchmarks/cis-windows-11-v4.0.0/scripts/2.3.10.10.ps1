...
$ExpectedDescription = "restrictremotesam = O:BAG:BAD:(A;;RC;;;BA)"
$SettingTitle = "2.3.10.10 - Ensure 'Network access: Restrict clients allowed to make remote calls to SAM' is set to 'Administrators: Remote Access: Allow'"
