...
$Name = "ConfigureKernelShadowSta"
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "ConfigureKernelShadowSta = 1"
$SettingTitle = "18.9.5.7 - Ensure 'Turn On Virtualization Based Security: Kernel-mode Hardware-enforced Stack Protection' is set to 'Enabled: Enabled in enforcement mode'"
