...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "RDVDenyWriteAccess = 1"
$SettingTitle = "18.10.10.3.11 - (BL) Ensure 'Deny write access to removable drives not protected by BitLocker' is set to 'Enabled'"
