...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "PromptOnSecureDesktop = 1"
$SettingTitle = "2.3.17.7 - Ensure 'User Account Control: Switch to the secure desktop when prompting for elevation' is set to 'Enabled'"
