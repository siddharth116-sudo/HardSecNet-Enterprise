...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "DisableDomainCreds = 1"
$SettingTitle = "2.3.10.4 - Ensure 'Network access: Do not allow storage of passwords and credentials for network authentication' is set to 'Enabled'"
