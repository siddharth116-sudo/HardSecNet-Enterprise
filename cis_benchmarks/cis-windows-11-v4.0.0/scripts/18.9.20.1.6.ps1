...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "NoWebService = 1"
$SettingTitle = "18.9.20.1.6 - Ensure 'Turn off Internet download for Web publishing and online ordering wizards' is set to 'Enabled'"
