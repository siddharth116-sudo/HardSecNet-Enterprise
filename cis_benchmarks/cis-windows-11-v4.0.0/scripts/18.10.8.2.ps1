...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "NoAutorun = 1"
$SettingTitle = "18.10.8.2 - Ensure 'Set the default behavior for AutoRun' is set to 'Enabled: Do not execute any autorun commands'"
