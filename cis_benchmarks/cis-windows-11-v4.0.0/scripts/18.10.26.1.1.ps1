...
$PropertyType = "String"
$DesiredValue = '0'
$ExpectedDescription = "Retention = 0"
$SettingTitle = "18.10.26.1.1 - Ensure 'Application: Control Event Log behavior when the log file reaches its maximum size' is set to 'Disabled'"
