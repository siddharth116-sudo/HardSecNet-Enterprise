...
$Name = "EnableMSAppInstallerPro"
$PropertyType = "DWord"
$DesiredValue = 0
$ExpectedDescription = "EnableMSAppInstallerPro = 0"
$SettingTitle = "18.10.18.6 - Ensure 'Enable App Installer ms-appinstaller protocol' is set to 'Disabled'"
