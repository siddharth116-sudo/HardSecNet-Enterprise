...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "RpcAuthnLevelPrivacyEnabled = 1"
$SettingTitle = "18.7.8 - Ensure 'Configure RPC packet level privacy setting for incoming connections' is set to 'Enabled'"
