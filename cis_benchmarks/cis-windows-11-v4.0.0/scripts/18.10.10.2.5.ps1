...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "OSRecoveryPassword = 1"
$SettingTitle = "18.10.10.2.5 - (BL) Ensure 'Choose how BitLocker-protected operating system drives can be recovered: Recovery Password' is set to 'Enabled: Require 48-digit recovery password'"
