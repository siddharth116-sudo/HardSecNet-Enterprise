...
$Name = "DisablePerUserUnsignedPackagesB"
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "DisablePerUserUnsignedPackagesB = 1"
$SettingTitle = "18.10.4.2 - Ensure 'Not allow per-user unsigned packages to install by default (requires explicitly allow per install)' is set to 'Enabled'"
