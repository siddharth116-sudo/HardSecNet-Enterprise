...
$PropertyType = "DWord"
$DesiredValue = 0
$ExpectedDescription = "EnableBDEWithNoTPM = 0"
$SettingTitle = "18.10.10.2.11 - (BL) Ensure 'Require additional authentication at startup: Allow BitLocker without a compatible TPM' is set to 'Enabled: False'"
