...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "EnableSecuritySignature = 1"
$SettingTitle = "2.3.8.2 - Ensure 'Microsoft network client: Digitally sign communications (if server agrees)' is set to 'Enabled'"
