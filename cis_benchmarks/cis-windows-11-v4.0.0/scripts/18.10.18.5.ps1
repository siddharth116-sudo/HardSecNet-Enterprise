...
$Name = "EnableBypassCertificate"
$PropertyType = "DWord"
$DesiredValue = 0
$ExpectedDescription = "EnableBypassCertificate = 0"
$SettingTitle = "18.10.18.5 - Ensure 'Enable App Installer Microsoft Store Source Certificate Validation Bypass' is set to 'Disabled'"
