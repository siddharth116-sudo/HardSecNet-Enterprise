...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "EnableVirtualization = 1"
$SettingTitle = "2.3.17.8 - Ensure 'User Account Control: Virtualize file and registry write failures to per-user locations' is set to 'Enabled'"
