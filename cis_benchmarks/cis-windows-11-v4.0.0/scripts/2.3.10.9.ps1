...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "RestrictNullSessAccess = 1"
$SettingTitle = "2.3.10.9 - Ensure 'Network access: Restrict anonymous access to Named Pipes and Shares' is set to 'Enabled'"
