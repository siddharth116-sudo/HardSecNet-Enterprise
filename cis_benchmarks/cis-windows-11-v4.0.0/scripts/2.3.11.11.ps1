...
$ExpectedDescription = "NTLMMinServerSec = 537395200"
$SettingTitle = "2.3.11.11 - Ensure 'Network security: Minimum session security for NTLM SSP based (including secure RPC) servers' is set to 'Require NTLMv2 session security, Require 128-bit encryption'"
