...
$PropertyType = "DWord"
$DesiredValue = 0
$ExpectedDescription = "EnableMPR = 0"
$SettingTitle = "18.10.82.1 - Ensure 'Configure the transmission of the user's password in the content of MPR notifications sent by winlogon.' is set to 'Disabled'"
