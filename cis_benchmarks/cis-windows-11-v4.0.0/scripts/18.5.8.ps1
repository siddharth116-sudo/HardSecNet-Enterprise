...
$PropertyType = "DWord"
$DesiredValue = 0
$ExpectedDescription = "PerformRouterDiscover = 0"
$SettingTitle = "18.5.8 - Ensure 'MSS: (PerformRouterDiscovery) Allow IRDP to detect and configure Default Gateway addresses' is set to 'Disabled'"
