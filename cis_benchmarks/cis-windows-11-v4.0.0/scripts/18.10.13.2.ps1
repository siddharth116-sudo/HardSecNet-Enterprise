...
$Name = "DisableCloudOptimizedCo"
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "DisableCloudOptimizedCo = 1"
$SettingTitle = "18.10.13.2 - Ensure 'Turn off cloud optimized content' is set to 'Enabled'"
