...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "RDVEnforceUserCert = 1"
$SettingTitle = "18.10.10.3.10 - (BL) Ensure 'Configure use of smart cards on removable data drives: Require use of smart cards on removable data drives' is set to 'Enabled: True'"
