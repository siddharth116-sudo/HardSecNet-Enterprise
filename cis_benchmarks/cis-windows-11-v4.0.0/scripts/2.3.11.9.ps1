...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "LDAPClientIntegrity = 1"
$SettingTitle = "2.3.11.9 - Ensure 'Network security: LDAP client signing requirements' is set to 'Negotiate signing' or higher"
