...
$Name = "EnableLocalArchiveMalwa"
$PropertyType = "DWord"
$DesiredValue = 0
$ExpectedDescription = "EnableLocalArchiveMalwa = 0"
$SettingTitle = "18.10.18.4 - Ensure 'Enable App Installer Local Archive Malware Scan Override' is set to 'Disabled'"
