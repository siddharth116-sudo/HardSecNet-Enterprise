...
$PropertyType = "DWord"
$DesiredValue = 0
$ExpectedDescription = "FDVHardwareEncryption = 0"
$SettingTitle = "18.10.10.1.7 - (BL) Ensure 'Configure use of hardware-based encryption for fixed data drives' is set to 'Disabled'"
