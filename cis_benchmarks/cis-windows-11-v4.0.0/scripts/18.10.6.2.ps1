...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "BlockHostedApp = 1"
$SettingTitle = "18.10.6.2 - Ensure 'Block launching Universal Windows apps with Windows Runtime API access from hosted content.' is set to 'Enabled'"
