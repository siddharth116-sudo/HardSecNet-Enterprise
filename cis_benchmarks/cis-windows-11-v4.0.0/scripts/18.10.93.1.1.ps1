...
$Name = "NoAutoRebootWithLog"
$PropertyType = "DWord"
$DesiredValue = 0
$ExpectedDescription = "NoAutoRebootWithLog = 0"
$SettingTitle = "18.10.93.1.1 - Ensure 'No auto-restart with logged on users for scheduled automatic updates installations' is set to 'Disabled'"
