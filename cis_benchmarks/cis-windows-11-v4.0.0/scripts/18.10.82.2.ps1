...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "DisableAutomat = 1"
$SettingTitle = "18.10.82.2 - Ensure 'Sign-in and lock last interactive user automatically after a restart' is set to 'Disabled'"
