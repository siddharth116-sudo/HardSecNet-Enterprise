...
$PropertyType = "DWord"
$DesiredValue = 0
$ExpectedDescription = "SCClipLevel = 0"
$SettingTitle = "18.10.57.3.3.8 - Ensure 'Restrict clipboard transfer from server to client' is set to 'Enabled: Disable clipboard transfers from server to client'"
