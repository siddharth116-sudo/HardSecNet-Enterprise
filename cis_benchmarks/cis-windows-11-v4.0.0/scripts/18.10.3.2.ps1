...
$Name = "DisableApplicationFootprin"
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "DisableApplicationFootprin = 1"
$SettingTitle = "18.10.3.2 - Ensure 'Turn off Application Footprint' is set to 'Enabled'"
