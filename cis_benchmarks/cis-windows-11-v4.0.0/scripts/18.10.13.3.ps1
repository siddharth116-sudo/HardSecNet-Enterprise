...
$Name = "DisableWindowsConsumerF"
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "DisableWindowsConsumerF = 1"
$SettingTitle = "18.10.13.3 - Ensure 'Turn off Microsoft consumer experiences' is set to 'Enabled'"
