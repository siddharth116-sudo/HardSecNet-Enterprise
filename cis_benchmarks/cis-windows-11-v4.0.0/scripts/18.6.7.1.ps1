...
$Name = "AuditClientDoesNotSuppo"
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "AuditClientDoesNotSuppo = 1"
$SettingTitle = "18.6.7.1 - Ensure 'Audit client does not support encryption' is set to 'Enabled'"
