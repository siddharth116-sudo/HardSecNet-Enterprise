...
$Name = "HypervisorEnforcedCodeIn"
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "HypervisorEnforcedCodeIn = 1"
$SettingTitle = "18.9.5.3 - Ensure 'Turn On Virtualization Based Security: Virtualization Based Protection of Code Integrity' is set to 'Enabled with UEFI lock'"
