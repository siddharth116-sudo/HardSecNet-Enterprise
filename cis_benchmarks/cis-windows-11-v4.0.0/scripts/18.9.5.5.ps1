...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "LsaCfgFlags = 1"
$SettingTitle = "18.9.5.5 - Ensure 'Turn On Virtualization Based Security: Credential Guard Configuration' is set to 'Enabled with UEFI lock'"
