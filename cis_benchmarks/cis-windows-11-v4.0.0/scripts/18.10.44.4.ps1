...
$PropertyType = "DWord"
$DesiredValue = 0
$ExpectedDescription = "SaveFilesToHost = 0"
$SettingTitle = "18.10.44.4 - Ensure 'Allow files to download and save to the host operating system from Microsoft Defender Application Guard' is set to 'Disabled'"
