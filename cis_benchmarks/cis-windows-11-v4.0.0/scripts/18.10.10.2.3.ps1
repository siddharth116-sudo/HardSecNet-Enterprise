...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "OSRecovery = 1"
$SettingTitle = "18.10.10.2.3 - (BL) Ensure 'Choose how BitLocker-protected operating system drives can be recovered' is set to 'Enabled'"
