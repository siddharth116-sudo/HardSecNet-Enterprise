...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "EnableSecureUIAPaths = 1"
$SettingTitle = "2.3.17.5 - Ensure 'User Account Control: Only elevate UIAccess applications that are installed in secure locations' is set to 'Enabled'"
