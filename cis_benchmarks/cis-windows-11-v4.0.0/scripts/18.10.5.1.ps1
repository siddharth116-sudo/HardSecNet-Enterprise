...
$Name = "LetAppsActivateWithVoiceA"
$PropertyType = "DWord"
$DesiredValue = 2
$ExpectedDescription = "LetAppsActivateWithVoiceA = 2"
$SettingTitle = "18.10.5.1 - Ensure 'Let Windows apps activate with voice while the system is locked' is set to 'Enabled: Force Deny'"
