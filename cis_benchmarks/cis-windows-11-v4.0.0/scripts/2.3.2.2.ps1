...
$PropertyType = "DWord"
$DesiredValue = 0
$ExpectedDescription = "CrashOnAuditFail = 0"
$SettingTitle = "2.3.2.2 - Ensure 'Audit: Shut down system immediately if unable to log security audits' is set to 'Disabled'"
