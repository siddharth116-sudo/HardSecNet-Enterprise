...
$Name = "AllowSuggestedAppsInWind"
$PropertyType = "DWord"
$DesiredValue = 0
$ExpectedDescription = "AllowSuggestedAppsInWind = 0"
$SettingTitle = "18.10.80.1 - Ensure 'Allow suggested apps in Windows Ink Workspace' is set to 'Disabled'"
