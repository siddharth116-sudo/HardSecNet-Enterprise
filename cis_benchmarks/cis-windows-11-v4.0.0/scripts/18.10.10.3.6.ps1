...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "RDVHideRecoveryPage = 1"
$SettingTitle = "18.10.10.3.6 - (BL) Ensure 'Choose how BitLocker-protected removable drives can be recovered: Omit recovery options from the BitLocker setup wizard' is set to 'Enabled: True'"
