...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "AllowAppHVSI_ProviderSet = 1"
$SettingTitle = "18.10.44.6 - Ensure 'Turn on Microsoft Defender Application Guard in Managed Mode' is set to 'Enabled: 1'"
