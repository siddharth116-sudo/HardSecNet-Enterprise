...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "CopyFilesPolicy = 1"
$SettingTitle = "18.7.11 - Ensure 'Manage processing of Queue-specific files' is set to 'Enabled: Limit Queue-specific files to Color profiles'"
