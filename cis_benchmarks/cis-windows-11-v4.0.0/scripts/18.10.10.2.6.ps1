...
$PropertyType = "DWord"
$DesiredValue = 0
$ExpectedDescription = "OSRecoveryKey = 0"
$SettingTitle = "18.10.10.2.6 - (BL) Ensure 'Choose how BitLocker-protected operating system drives can be recovered: Recovery Key' is set to 'Enabled: Do not allow 256-bit recovery key'"
