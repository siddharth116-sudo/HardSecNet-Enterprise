...
$PropertyType = "DWord"
$DesiredValue = 0
$ExpectedDescription = "ForceGuest = 0"
$SettingTitle = "2.3.10.12 - Ensure 'Network access: Sharing and security model for local accounts' is set to 'Classic - local users authenticate as themselves'"
