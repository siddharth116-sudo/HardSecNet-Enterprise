...
$Name = "EnableWindowsPackageMan"
$PropertyType = "DWord"
$DesiredValue = 0
$ExpectedDescription = "EnableWindowsPackageMan = 0"
$SettingTitle = "18.10.18.7 - Ensure 'Enable Windows Package Manager command line interfaces' is set to 'Disabled'"
