...
$PropertyType = "DWord"
$DesiredValue = 0
$ExpectedDescription = "EveryoneIncludesAnonymous = 0"
$SettingTitle = "2.3.10.5 - Ensure 'Network access: Let Everyone permissions apply to anonymous users' is set to 'Disabled'"
