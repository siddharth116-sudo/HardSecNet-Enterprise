...
$PropertyType = "DWord"
$DesiredValue = 1
$ExpectedDescription = "RestrictAnonymousSAM = 1"
$SettingTitle = "2.3.10.2 - Ensure 'Network access: Do not allow anonymous enumeration of SAM accounts' is set to 'Enabled'"
