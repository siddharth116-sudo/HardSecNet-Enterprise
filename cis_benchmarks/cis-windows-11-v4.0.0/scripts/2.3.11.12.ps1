...
$PropertyType = "DWord"
$DesiredValue = 2
$ExpectedDescription = "AuditReceivingNTLMTraffic = 2"
$SettingTitle = "2.3.11.12 - Ensure 'Network security: Restrict NTLM: Audit Incoming NTLM Traffic' is set to 'Enable auditing for all accounts'"
